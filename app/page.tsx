...
const VideoTranscriptSync = dynamic(
  () => import("@/components/VideoTranscriptSync"),
  {
    ssr: false,
    loading: () => <div className="flex flex-col items-center gap-4"></div>,
  },
);
...
export default function Home() {
  ...
  return (
    <main>
      <VideoTranscriptSync videoId={videoId} />
    </main>
  );
}
